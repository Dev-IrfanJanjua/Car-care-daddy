    ...
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        <SheetContent
          ...
          data-slot="sidebar"
          data-mobile="true"
          className="w-(--sidebar-width) bg-sidebar p-0 text-sidebar-foreground duration-300 ease-[cubic-bezier(0.32,0.72,0,1)] data-[side=left]:data-starting-style:translate-x-[-100%] data-[side=left]:data-ending-style:translate-x-[-100%] data-[side=right]:data-starting-style:translate-x-[100%] data-[side=right]:data-ending-style:translate-x-[100%] [&>button]:hidden"
          style={
            {
